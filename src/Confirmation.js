  	...
  	return(
        ...
        <div class="card-panel white">
        	<div class="center">
        		...
        		<p class="margin-top-20">{this.props.fieldValues.streetName}, {this.props.fieldValues.streetNo}</p>
        		<p class="margin-top-20">{this.props.fieldValues.postcode} {this.props.fieldValues.cityName}</p>
